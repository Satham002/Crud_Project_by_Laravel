            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <input type="text" id="name" name="name"
                        ...
                        placeholder="Enter your Product" value="{{ old('name') }}">
                    @if ($errors->has('name'))
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @if ($errors->has('mrp')) {{ 'is-invalid' }} @endif"
                        name="mrp" id="MRP" placeholder="Enter your MRP" value="{{ old('mrp') }}">
                    @if ($errors->has('mrp'))
                        <div class="invalid-feedback">
                            {{ $errors->first('mrp') }}
                        </div>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <textarea name="description" id="description"
                        ...
                        style="resize: none;" name="description" placeholder="Enter Your Description">{{ old('description') }}
                    </textarea>
